...
Route::prefix('v1')->namespace('Api')->middleware('change-locale')->name('api.v1.')->group(function() {
    ...
    Route::middleware('throttle:' . config('api.rate_limits.sign'))->group(function() {
        ...
        // 第三方登录
        Route::post('socials/{social_type}/authorizetions', 'AuthorizationsController@socialStore')
            ->where('social_type', 'wechat')
            ->name('socials.authorizetions.store');
        // 登录
    ...
    Route::middleware('throttle:' . config('api.rate_limits.access'))->group(function() {
        ...
        Route::middleware('auth:api')->group(function() {
            ...
            Route::put('user/read/notifications', 'NotificationsController@read')->name('user.notifications.read');
            // 当前登录用户的用户权限
